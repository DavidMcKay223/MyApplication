...
| `Identifiers` | `List<IdentifierDto>?` | `#endregion<br><br>        #region -- Identifiers --<br>        public List<IdentifierDto>? Identifiers { get; set; }` |
| `Endpoints` | `List<EndpointDto>?` | `#endregion<br><br>        #region -- Endpoints --<br>        public List<EndpointDto>? Endpoints { get; set; }` |
| `DynamicName` | `string?` | `#endregion<br><br>        #region -- Dynamic --<br>        public string? DynamicName => string.IsNullOrWhiteSpace(OtherOrganizationName) ? Name : OtherOrganizationName;` |
| `DynamicLegalName` | `string?` | `public string? DynamicLegalName => string.IsNullOrWhiteSpace(ParentOrganizationLegalBusinessName) ? Name : ParentOrganizationLegalBusinessName;` |
